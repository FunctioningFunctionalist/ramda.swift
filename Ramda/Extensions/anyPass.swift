...
extension R {
    ...
    public class func anyPass<A>(_ array: [(A) -> Bool], with first: A) -> Bool {
    ...
    */
    ...
    public class func anyPass<A, B>(_ array: [(A, B) -> Bool], with first: A, and second: B) -> Bool {
    ...
    */
    ...
    public class func anyPass<A, B, C>(_ array: [(A, B, C) -> Bool], with first: A, _ second: B, and third: C) -> Bool {
    ...
    public class func anyPass<A, B, C, D>(_ array: [(A, B, C, D) -> Bool], with first: A, _ second: B, _ third: C, and fourth: D) -> Bool {
    ...
    */
    ...
    public class func anyPass<A>(_ array: [(A) -> Bool]) -> (_ with: A) -> Bool {
    ...
    */
    ...
    public class func anyPass<A, B>(_ array: [(A, B) -> Bool]) -> (_ with: A) -> (_ and: B) -> Bool {
        return curry(anyPass)(array)
    }
    ...
    */
    ...
    public class func anyPass<A, B, C>(_ array: [(A, B, C) -> Bool]) -> (_ with: A) -> (B) -> (_ and: C) -> Bool {
        return curry(anyPass)(array)
    }
    ...
    public class func anyPass<A, B, C, D>(_ array: [(A, B, C, D) -> Bool]) -> (_ with: A) -> (B) -> (C) -> (_ and: D) -> Bool {
        return curry(anyPass)(array)
    }
}
