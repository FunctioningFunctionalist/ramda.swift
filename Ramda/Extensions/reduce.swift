...
extension R {
    ...
    */
    ...
    public class func reduce<A, B: SequenceType>(iterator: (A, B.Generator.Element) -> A, startingAt initialValue: A, in sequence: B) -> A {
    ...
    */
    ...
    public class func reduce<A, B: SequenceType>(iterator: (A, B.Generator.Element) -> A) -> (startingAt: A) -> (in: B) -> A {
